 ...
 <?php include("inc/mobile_navigation.php"); ?>
  ...
  <header id="headerImage" class="image-bg-fluid-height-1">
    <div data-id="1" class="col-md-6 overSlideShowDiv">
     ...
     <div data-id="2" class="col-md-6 overSlideShowDiv" style="display: none;">
      <div class="overSlideShowTextDiv">
        <div class="dropup">
          <span class="glyphicon glyphicon-triangle-top pull-right" aria-hidden="true"></span>
        </div>
     ...
     <div data-id="3" class="col-md-6 overSlideShowDiv" style="display: none;">
      <div class="overSlideShowTextDiv">
        <div class="dropup">
          <span class="glyphicon glyphicon-triangle-top pull-right" aria-hidden="true"></span>
        </div>
     ...
     <div data-id="4" class="col-md-6 overSlideShowDiv" style="display: none;">
      <div class="overSlideShowTextDiv">
        <div class="dropup">
          <span class="glyphicon glyphicon-triangle-top pull-right" aria-hidden="true"></span>
        </div>
     ...
     <div data-id="5" class="col-md-6 overSlideShowDiv" style="display: none;">
      <div class="overSlideShowTextDiv">
        <div class="dropup">
          <span class="glyphicon glyphicon-triangle-top pull-right" aria-hidden="true"></span>
        </div>
     ...
     <div data-id="6" class="col-md-6 overSlideShowDiv" style="display: none;">
      <div class="overSlideShowTextDiv">
        <div class="dropup">
          <span class="glyphicon glyphicon-triangle-top pull-right" aria-hidden="true"></span>
        </div>
  ...
  <div class="row">
    <div class="col-md-12 twitter">
      <div class="col-lg-2 twitterlogo">
