    ...
    <div class="col-md-12 contentwrapper1">
      <div class="col-lg-3 menu_left">
        <ul class="nav_left hidden-xs hidden-sm hidden-md">
          <li class="level-1 first"><a href="#">level-1 first</a></li>
          <li class="level-1 parent-menu-active"><a href="#">level-1 parent-menu-active</a>
            <ul class="nav_sub">
              <li class="level-2 first"><a href="#">level-2 first</a></li>
              <li class="level-2 parent-menu-active"><a href="#">level-2 active</a></li>
              <li class="level-2"><a href="#">level-2</a></li>
              <li class="level-2"><a href="#">level-2</a></li>
            </ul>
          </li>
          <li class="level-1"><a href="#">level-1</a></li>
          <li class="level-1"><a href="#">level-1</a></li>
        </ul>
      </div>
