    ...
    <div class="col-md-12">
      ...
      <div class="col-md-3 menu" id="menu_top_left">
        <ul id="nav_main">
          ...
          <li class="top_menu_active"><a href="contact_administrators.php">Contact</a></li>
        </ul>
      </div>
  ...
  <div class="row">
    <div class="col-md-12 breadcrumb">
      <div class="col-lg-9 pull-right">
        ...
        <span class="activePage">Shareholder enquiries</span>
      </div>
    </div>
  </div>
  <div class="row">
    <div class="col-md-12 contentwrapper1">
      <div class="col-lg-3 menu_left">
        <ul class="nav">
          ...
          <li class="level-1 parent-menu-active"><a href="contact_shareholderenquiries.php">Shareholder enquiries</a>
          <li class="level-1"><a href="contact_investmentadvisers.php">Investment Advisers</a></li>
          <li class="level-1"><a href="contact_publicrelations.php">Public Relations</a></li>
        </ul>
      </div>
      <div class="col-lg-6 content1">
        <h1>Shareholder Enquiries</h1>
        <h3>h3</h3>
        <p>paragraph</p>
      </div>
