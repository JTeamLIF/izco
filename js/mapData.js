...
},
{
   ...
   "value":2000000,
   "color":"#0094d9",
   "desc":"Support Services (SEL) Limited has contracted with the London Mayor’s Office for Policing and Crime (MOPAC)  to design, build, finance, maintain and operate three new Borough headquarter police stations and one smaller sector base in the London Boroughs of Lewisham, Sutton and Deptford, including facilities for the Serious Crime Group and Mounted Branch and general facilities management and staffing services associated with the police operations under a 25 year concession which runs until 2029.",
   "ownership":50,
   "address":"United Kingdom",
...
function turnAllAssetsOff(category) {
  $('.' + category + ' .smallAsset').each(function () {
   $(this).removeClass('smallAssetActive');
