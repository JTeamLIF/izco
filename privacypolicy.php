...
<?php $categorytitle = 'Privacy Policy'; ?>
<body>
  ...
  <div class="row">
    <div class="col-md-12 breadcrumb">
      <div class="col-lg-9 pull-right">
        ...
        <span class="activePage">Privacy Policy</span>
      </div>
    </div>
  </div>
  <div class="row">
    <div class="col-md-12 contentwrapper1">
      <div class="col-lg-3 menu_left">
        <ul class="nav_left hidden-xs">
          ...
          <li class="level-1 parent-menu-active"><a href="privacypolicy.php">Privacy Policy</a></li>
      ...
      <div class="col-lg-6 content1">
        ...
        <p>We do not pass on any of your personal details, or sell mailing list data, to third parties.<br />
<br />
Website statistics are produced, using a harmless item known as a cookie, allowing us to record visitor numbers, number of pages viewed and referral source. These statistics do not record any personal data. This data simply helps us to administer and enhance the site and service.<br />
<br />
You can turn cookies off. Please refer to the help section of your browser software for instructions on how to do this.<br />
</p>
      </div>
