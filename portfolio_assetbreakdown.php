...
<div class="im-centered"> 
  ...
  <div class="row">
    <div class="col-md-12 breadcrumb">
      <div class="col-lg-9 pull-right"> <span class="previousPage"><a href="index.php">Home</a></span> | <span class="activePage">Portfolio</span> | <span class="activePage">Asset Breakdown</span> </div>
    </div>
  </div>
  <div class="row">
    <div class="col-md-12 contentwrapper1">
      ...
      <div class="col-lg-6 content1">
        ...
        <h3>The original Seed Portfolio of 19 assets was acquired for a total of &pound;259.0 million using a weighted average discount rate of 8.35%. Since then, JLIF has made over &pound;590 million of additional investments in assets from both John Laing and the wider secondary market. JLIF's Portfolio as at 30 September 2015 was valued at &pound;876.6 million using a weighted average discount rate of 7.94%. The total the number of assets in the Portfolio currently stands at 57.</h3>
      </div>
